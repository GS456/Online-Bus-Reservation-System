							...
							while($row = mysql_fetch_array($result))
								{
									...
									while($rows = mysql_fetch_array($results))
										{
									echo '<td><div align="right">'.$rows['Origin'].'</div></td>';
									echo '<td><div align="right">'.$rows['Destination'].'</div></td>';
									...
									echo '<td><div align="center"> <a href="#" id="'.$row['transactionum'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
